...
const MyProfile = () => {
  // 버튼 hover
  const [informationButtonHovered, setInformationButtonHovered] = useState(false);
  ...
  return (
    <div style={body}>
      <div style={containerStyle}>
        ...
        <div style={profileContainerStyle}>
          <div style={infoContainerStyle}>
            <img src={DefaultProfileImage} alt="프로필 이미지" style={profileImageStyle} />
            <div>
      ...
      <div style={containerStyle}>
        ...
        <div style={profileContainerStyle}>
          <div style={infoContainerStyle}>
            <img src={DefaultProfileImage} alt="소비성향 이미지" style={testImageStyle} />
